...
def risk():
    ...
    answer1 = (input("how many attackers in the current roll?(1-3)"))
    while True:
        if len(answer1) > 2: # or (len(answer2) > 2):
            print("wrong format!")
            answer1 = (input("how many attackers in the current roll?(1-3)")) 
        elif re.search("[a-z]",answer1):
            print("wrong format!")
            answer1 = (input("how many attackers in the current roll?(1-3)")) 
        else:
            break 
    answer2 = (input("how many defenders in the current roll?(1-2)")) 
    while True:
        if len(answer2) > 2: 
            print("wrong format!")
            answer2 = (input("how many defenders in the current roll?(1-2)"))
        elif re.search("[a-z]",answer2):
            print("wrong format!")
            answer2 = (input("how many defenders in the current roll?(1-2)")) 
        else:
            break
